...
function breadcrumbsForPath(
  ...
  if (normalized === "/app/settings") return [{ label: "Impostazioni" }];
        ...
        >
          ...
          <nav className="flex min-h-0 flex-1 flex-col gap-1 overflow-y-auto overscroll-contain p-2.5">
            ...
            <Link
              ...
              onClick={() => setMenuOpen(false)}
              className={
                pathname === "/app/settings" ? uiNavActive : uiNavItem
              }
            >
              <svg
                className={cn(
            ...
            {canManageUsers(me?.role ?? "operator") ? (
              <Link
                ...
                onClick={() => setMenuOpen(false)}
                className={
                  pathname === "/app/settings/users" ? uiNavActive : uiNavItem
                }
              >
                <svg
                  className={cn(
            ...
            {canManageTeams(me?.role ?? "operator") ? (
              <Link
                href="/app/settings/teams"
                onClick={() => setMenuOpen(false)}
                className={
                  pathname === "/app/settings/teams" ? uiNavActive : uiNavItem
                }
              >
                <svg
                  className={cn(
                    "h-4 w-4 shrink-0",
                    pathname === "/app/settings/teams"
                      ? "text-accent"
                      : "text-fg-tertiary",
                  )}
                  fill="none"
          ...
          <div className="shrink-0 border-t border-line-default p-2.5">
            ...
            <div className="flex items-center justify-between gap-2">
              ...
              <button
                ...
                className={cn(uiBtnGhost, "shrink-0 px-2 py-1.5 text-xs")}
              >
                Esci
              </button>
            </div>
