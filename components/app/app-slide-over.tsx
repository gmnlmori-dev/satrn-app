...
export type AppSlideOverProps = {
  open: boolean;
  onClose: () => void;
  title: string;
  description?: string;
  children: ReactNode;
  /** `left` (default, da sinistra) o `right` (mobile-friendly). */
  slideFrom?: "left" | "right";
  /** Usa portal su document.body (consigliato per overlay globali). */
  portal?: boolean;
};

export function AppSlideOver({
  open,
  onClose,
  title,
  description,
  ...
  const hiddenTransform =
    slideFrom === "right"
      ...
      : "-translate-x-full md:-translate-x-[105%]";
    ...
    <>
      ...
      <div
        ...
        className={cn(
          ...
          entered ? "translate-x-0" : hiddenTransform,
        )}
      >
